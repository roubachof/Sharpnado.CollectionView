...
namespace DragAndDropSample.Navigables
{
    /// <summary>
    ...
    public interface IViewLocator
    {
        ...
        /// <returns>
        /// </returns>
        ContentPage GetViewFor<TViewModel>()
        ...
        /// <returns>
        /// </returns>
        ContentPage GetViewFor<TViewModel>(TViewModel viewModel, NavigationTransition transition)
            where TViewModel : ANavigableViewModel;
