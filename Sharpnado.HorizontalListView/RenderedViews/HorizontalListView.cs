...
namespace Sharpnado.HorizontalListView.RenderedViews
{
    ...
    public class ListLayoutChangedEventArgs : EventArgs
    {
        public ListLayoutChangedEventArgs(HorizontalListViewLayout listLayout)
        {
            ListLayout = listLayout;
        }

        public HorizontalListViewLayout ListLayout { get; }
    }
    ...
    public class HorizontalListView : View
    {
        ...
        {
            if (ListLayout == HorizontalListViewLayout.Grid || ListLayout == HorizontalListViewLayout.Vertical || ItemHeight > 0)
            {
                throw new InvalidOperationException(
        ...
        private static void OnListLayoutChanging(BindableObject bindable, object oldvalue, object newvalue)
        {
            ...
            if (newLayout == HorizontalListViewLayout.Vertical)
            {
            ...
            horizontalListView.ListLayoutChanging?.Invoke(
                horizontalListView,
