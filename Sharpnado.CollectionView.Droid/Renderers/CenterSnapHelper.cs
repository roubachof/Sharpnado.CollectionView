...
namespace Sharpnado.CollectionView.Droid.Renderers
{
    ...
    {
        public CenterSnapHelper(CollectionViewRenderer nativeView)
        {
            WeakNativeView = new WeakReference<CollectionViewRenderer>(nativeView);
        }
        ...
        protected WeakReference<CollectionViewRenderer> WeakNativeView { get; }
